...
PFBAConfig::PFBAConfig(Renderer *renderer, const std::string &home, int version)
    ...
    ////////////////////////////////////////////////////////////
    // main/gui config
    getOptions()->emplace_back(C2DUIOption("MAIN", {"MAIN"}, 0, C2DUIOption::Index::MENU_MAIN, C2DUIOption::Type::MENU));
    ...
    getOptions()->emplace_back(
            C2DUIOption("SKIN", {"SKIN"}, 0, C2DUIOption::Index::MENU_SKIN, C2DUIOption::Type::MENU | C2DUIOption::Type::HIDDEN));
    getOptions()->emplace_back(
    ...
    getOptions()->emplace_back(C2DUIOption("NEOBIOS", {"UNIBIOS_3_2", "AES_ASIA", "AES_JPN", "DEVKIT", "MVS_ASIA_EUR_V6S1",
    ...
    // joystick
    getOptions()->emplace_back(C2DUIOption("JOYPAD", {"JOYPAD"}, 0, C2DUIOption::Index::MENU_JOYPAD, C2DUIOption::Type::MENU));
    getOptions()->emplace_back(
            C2DUIOption("JOY_UP", {"-1"}, KEY_JOY_UP_DEFAULT, C2DUIOption::Index::JOY_UP, C2DUIOption::Type::INPUT));
    getOptions()->emplace_back(
            C2DUIOption("JOY_DOWN", {"-1"}, KEY_JOY_DOWN_DEFAULT, C2DUIOption::Index::JOY_DOWN, C2DUIOption::Type::INPUT));
    getOptions()->emplace_back(
            C2DUIOption("JOY_LEFT", {"-1"}, KEY_JOY_LEFT_DEFAULT, C2DUIOption::Index::JOY_LEFT, C2DUIOption::Type::INPUT));
    getOptions()->emplace_back(
            C2DUIOption("JOY_RIGHT", {"-1"}, KEY_JOY_RIGHT_DEFAULT, C2DUIOption::Index::JOY_RIGHT, C2DUIOption::Type::INPUT));
    getOptions()->emplace_back(
            C2DUIOption("JOY_FIRE1", {"0"}, KEY_JOY_FIRE1_DEFAULT, C2DUIOption::Index::JOY_FIRE1, C2DUIOption::Type::INPUT));
    getOptions()->emplace_back(
            C2DUIOption("JOY_FIRE2", {"1"}, KEY_JOY_FIRE2_DEFAULT, C2DUIOption::Index::JOY_FIRE2, C2DUIOption::Type::INPUT));
    getOptions()->emplace_back(
            C2DUIOption("JOY_FIRE3", {"2"}, KEY_JOY_FIRE3_DEFAULT, C2DUIOption::Index::JOY_FIRE3, C2DUIOption::Type::INPUT));
    getOptions()->emplace_back(
            C2DUIOption("JOY_FIRE4", {"3"}, KEY_JOY_FIRE4_DEFAULT, C2DUIOption::Index::JOY_FIRE4, C2DUIOption::Type::INPUT));
    getOptions()->emplace_back(
            C2DUIOption("JOY_FIRE5", {"4"}, KEY_JOY_FIRE5_DEFAULT, C2DUIOption::Index::JOY_FIRE5, C2DUIOption::Type::INPUT));
    getOptions()->emplace_back(
            C2DUIOption("JOY_FIRE6", {"5"}, KEY_JOY_FIRE6_DEFAULT, C2DUIOption::Index::JOY_FIRE6, C2DUIOption::Type::INPUT));
    getOptions()->emplace_back(
            C2DUIOption("JOY_COIN1", {"6"}, KEY_JOY_COIN1_DEFAULT, C2DUIOption::Index::JOY_COIN1, C2DUIOption::Type::INPUT));
    getOptions()->emplace_back(
            C2DUIOption("JOY_START1", {"7"}, KEY_JOY_START1_DEFAULT, C2DUIOption::Index::JOY_START1, C2DUIOption::Type::INPUT));
    // TODO: add gui option for axis in option menu
    getOptions()->emplace_back(
            C2DUIOption("JOY_AXIS_LX", {"0"}, KEY_JOY_AXIS_LX, C2DUIOption::Index::JOY_AXIS_LX, C2DUIOption::Type::HIDDEN));
    getOptions()->emplace_back(
            C2DUIOption("JOY_AXIS_LY", {"1"}, KEY_JOY_AXIS_LY, C2DUIOption::Index::JOY_AXIS_LY, C2DUIOption::Type::HIDDEN));
    getOptions()->emplace_back(
            C2DUIOption("JOY_AXIS_RX", {"2"}, KEY_JOY_AXIS_RX, C2DUIOption::Index::JOY_AXIS_RX, C2DUIOption::Type::HIDDEN));
    getOptions()->emplace_back(
            C2DUIOption("JOY_AXIS_RY", {"3"}, KEY_JOY_AXIS_RY, C2DUIOption::Index::JOY_AXIS_RY, C2DUIOption::Type::HIDDEN));
...
#ifndef NO_KEYBOARD
    // keyboard
    getOptions()->emplace_back(C2DUIOption("KEYBOARD", {"KEYBOARD"}, 0, C2DUIOption::Index::MENU_KEYBOARD, C2DUIOption::Type::MENU));
    ...
    //
    getOptions()->emplace_back(C2DUIOption("END", {"END"}, 0, C2DUIOption::Index::END, C2DUIOption::Type::MENU));


    // set default rom options
    getOptions(true)->clear();
    for (unsigned int i = C2DUIOption::Index::MENU_ROM_OPTIONS; i < C2DUIOption::Index::END; i++) {
        getOptions(true)->emplace_back(getOptions()->at(i));
    }
